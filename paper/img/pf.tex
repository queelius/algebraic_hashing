...
\begingroup%
  ...
  \begin{picture}(1,0.66884337)%
    ...
    \put(0.185,0.631){\color[rgb]{0,0,0}\makebox(0,0)[lb]{\smash{$\mathbb{X}$}}}%
    \put(0,0){\includegraphics[width=\unitlength,page=1]{img/pf.pdf}}%
    ...
    \put(0,0){\includegraphics[width=\unitlength,page=2]{img/pf.pdf}}%
    \put(0.433,0.12){\color[rgb]{0,0,0}\makebox(0,0)[lb]{\smash{$\operatorname{hash}_{\mathbb{X}}^{0.6}(c)$}}}%
    \put(0,0){\includegraphics[width=\unitlength,page=3]{img/pf.pdf}}%
  \end{picture}%
\endgroup%
