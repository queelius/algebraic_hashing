...
namespace alex::ringmod
{
    ...
    {
        return RingMod<N>{ internal::add_mod_n_op(a.digits, b.digits) };
    }

    template <size_t N>
    RingMod<N> operator^(RingMod<N> a, RingMod<N> b)
    {
        return RingMod<N>{ internal::xor_op(a.digits, b.digits) };
    }

    template <size_t N>
    RingMod<N> operator*(RingMod<N> a, RingMod<N> b)
    {
        return RingMod<N>{ internal::multiply_mod_n_op(a.digits, b.digits) };
    }

    RingMod<1> operator "" _mod2(const char* x)
    {
        return ring_mod_from_binary<1>(x);
    };
    ...
    RingMod<3> operator "" _mod8(const char* x)
    {
        return ring_mod_from_binary<3>(x);
    };
    ...
    RingMod<8> operator "" _mod256(const char* x)
    {
        return ring_mod_from_binary<8>(x);
    };

    RingMod<10> operator "" _mod1024(const char* x)
    {
        return ring_mod_from_binary<10>(x);
    };

    RingMod<64> operator "" _modpow64(const char* x)
    {
        return ring_mod_from_binary<64>(x);
    };

    RingMod<128> operator "" _modpow128(const char* x)
    {
        return ring_mod_from_binary<128>(x);
    };

    RingMod<1024> operator "" _modpow1024(const char* x)
    {
        return ring_mod_from_binary<1024>(x);
    };
