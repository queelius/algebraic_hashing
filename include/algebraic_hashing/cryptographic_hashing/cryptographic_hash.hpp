...
{
    template <>
    struct hash<algebraic_hashing::cryptographic_hashing::cryptographic_hash>
    {
        size_t operator()(algebraic_hashing::cryptographic_hashing::cryptographic_hash const & h) const
        {
            return h.fast_hash();
        }
    };
